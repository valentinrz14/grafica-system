...
export default function OrderDetailPage() {
  ...
  const handleStatusChange = async (newStatus: 'PENDING' | 'PRINTING' | 'DONE') => {
    if (!order) return;
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium text-gray-900">{order.options.size}</p>
                </div>
                <div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                {order.files.map((file) => (
                  <FilePreview key={file.id} file={file} showDownload={true} />
                ))}
              </div>
